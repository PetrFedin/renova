...
5. A pristine canonical test seed exposes the complete demo project set, including the apartment and house fixtures.
6. Real payments, SMS, provider credentials and production evidence remain out of scope for this stand.
