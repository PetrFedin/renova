...
**Дата создания:** 2026-07-15 · **Обновлено:** 2026-07-17 (post-P2.5)
...
| M4 | Work Acceptance | Нет error/offline UI | P0.1 + P1.5 | 🟡 queue OK; UI partial → P3.3e |
...
| M11 | SBP pay | alert без clipboard | P1.1 | 🟡 openSbp → P3.1c |
...
| B9 | CO → budget delta | P3.2c | ❌ planned |
