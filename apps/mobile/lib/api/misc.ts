...
import type { ApprovalItem, ArticleDetail, ArticleSummary } from './types';
export const miscApi = {
  ...
  shareViewer: (userId: string, projectId: string, phone: string) => req(`/api/v1/projects/${projectId}/viewers`, { method: 'POST', body: JSON.stringify({ phone }) }, userId),
