...
export const floorApi = {
  ...
  moveFloorPin: (userId: string, projectId: string, planId: string, pinId: string, x_pct: number, y_pct: number) => req(`/api/v1/projects/${projectId}/floor-plans/${planId}/pins/${pinId}`, { method: 'PATCH', body: JSON.stringify({ x_pct, y_pct }) }, userId),
  ...
  moveFurniture: (userId: string, projectId: string, itemId: string, x_pct: number, y_pct: number) => req(`/api/v1/projects/${projectId}/furniture/${itemId}`, { method: 'PATCH', body: JSON.stringify({ x_pct, y_pct }) }, userId),
