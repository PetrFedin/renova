...
const s = StyleSheet.create({ row:{ flexDirection:'row', flexWrap:'wrap', gap:6, marginVertical:6, alignItems:'center' }, lbl:{ fontSize:11, color:'#666' }, ch:{ paddingHorizontal:8, paddingVertical:4, borderRadius:10, backgroundColor:'#eee' }, on:{ backgroundColor:'#dc2626' }, t:{ fontSize:11 }, tOn:{ color:'#fff' } });
