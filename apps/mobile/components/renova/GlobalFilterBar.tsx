...
const s = StyleSheet.create({ box:{ marginVertical:6 }, lbl:{ fontWeight:'700', fontSize:12, marginBottom:4 }, row:{ flexDirection:'row', flexWrap:'wrap', gap:6, marginBottom:6 }, chip:{ paddingHorizontal:8, paddingVertical:4, borderRadius:12, backgroundColor:'#f3f4f6' }, on:{ backgroundColor:'#dbeafe' }, t:{ fontSize:11 }, onT:{ fontSize:11, fontWeight:'700', color:'#1d4ed8' } });
