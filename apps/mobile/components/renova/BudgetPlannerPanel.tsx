...
const s = StyleSheet.create({
  ...
  chip: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 14, backgroundColor: '#eee', borderWidth: 1, borderColor: RenovaTheme.colors.border },
  chipOn: { backgroundColor: '#EFF6FF', borderColor: RenovaTheme.colors.accent },
  ...
  trendBarWrap: { flex: 1, height: 8, backgroundColor: '#eee', borderRadius: 4, overflow: 'hidden' },
