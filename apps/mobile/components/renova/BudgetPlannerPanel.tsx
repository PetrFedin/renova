...
const s = StyleSheet.create({
  ...
  split: { backgroundColor: RenovaTheme.colors.accentMuted, borderRadius: 8, padding: 8, justifyContent: 'center' },
  splitMat: { backgroundColor: RenovaTheme.colors.warningBg },
  ...
  lemana: { paddingVertical: 8, borderTopWidth: 1, borderTopColor: RenovaTheme.colors.border },
  lemanaName: { fontWeight: '600', fontSize: 13 },
  lemanaMeta: { fontSize: 11, color: RenovaTheme.colors.accent, marginTop: 2 },
  matRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 6, borderTopWidth: 1, borderTopColor: RenovaTheme.colors.border },
