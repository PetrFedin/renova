...
const s = StyleSheet.create({
  ...
  chip: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 10, backgroundColor: '#eee', maxWidth: 140 },
  on: { backgroundColor: RenovaTheme.colors.primary }, txt: { fontWeight: '700', fontSize: 11, color: '#333' }, txtOn: { color: '#fff' },
});
