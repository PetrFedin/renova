...
const s = StyleSheet.create({
  ...
  me: { alignSelf: 'flex-end', backgroundColor: RenovaTheme.colors.accentMuted },
  ...
  reactChip: { backgroundColor: RenovaTheme.colors.surfaceMuted, borderRadius: 12, paddingHorizontal: 8, paddingVertical: 2 },
  ...
  replyBar: { flexDirection: 'row', alignItems: 'center', padding: 8, backgroundColor: RenovaTheme.colors.surfaceMuted, gap: 8 },
  ...
  systemWrap: { alignSelf: 'center', maxWidth: '90%', marginBottom: 8, paddingHorizontal: 12, paddingVertical: 6, backgroundColor: RenovaTheme.colors.surfaceMuted, borderRadius: 12 },
