...
const s = StyleSheet.create({
  ...
  row: { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, borderTopWidth: 1, borderTopColor: RenovaTheme.colors.border },
  rowOn: { backgroundColor: RenovaTheme.colors.background },
