  ...
  return (
    <>
      <ScrollView style={styles.wrap} contentContainerStyle={{ padding: 16 }}>
        ...
        {/*
          Это предварительный расчёт, а не смета объекта. На сервер уходят
          только комнаты, смету он считает сам и по своим нормам — на живом
          прогоне экран показывал 52 690 ₽ (работы 24 569 · материалы 25 612 ·
          резерв 2 509), а созданный объект получил 52 111 ₽ (работы 29 669 ·
          материалы 22 442 · резерв 0). Подпись «План из сметы (шаблон)» этого
          не говорила, и человек сверял свой бюджет с числом, которого потом
          не увидит.
        */}
        <Text style={styles.subLabel}>Предварительный расчёт по шаблону</Text>
        <Text style={styles.subLabel}>
          Точная смета появится после создания объекта — состав и сумма могут отличаться.
        </Text>
        <WizardHint
      ...
      <RenovationPlanBadge renovationType={wizard.renovation_type} propertyType={wizard.property_type} />
        ...
        */}
        ...
        <CustomerBudgetField
          ...
          estimateLabel="Предварительный расчёт"
          hint="Укажите, сколько готовы вложить. Приложение будет контролировать факт и перерасход относительно этого лимита. Сравнивать его будет с точной сметой объекта, а не с этим предварительным расчётом."
        />
