...
const s = StyleSheet.create({
  ...
  ptype: { flex: 1, padding: 10, borderRadius: 10, backgroundColor: '#eee', alignItems: 'center' },
  ptypeOn: { backgroundColor: RenovaTheme.colors.primary },
  ptypeT: { fontWeight: '700' },
  ptypeTOn: { fontWeight: '700', color: '#fff' },
  card: { backgroundColor: '#fff', padding: 12, borderRadius: 10, marginBottom: 10 },
  inp: { borderWidth: 1, borderColor: '#eee', borderRadius: 8, padding: 10, marginBottom: 8 },
