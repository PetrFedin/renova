...
export const RenovaTheme = {
  colors: {
    ...
    // Затемнение под шторками и окнами. Раньше в приложении жили пять разных
    // значений на 18 мест: 0.35, 0.4, 0.45, 0.5 и два разных базовых цвета —
    // и одинаковые по смыслу окна темнели по-разному.
