...
class Settings(BaseSettings):
    ...
    # Ops alert destination. In staging/production a configured destination requires working SMTP.
    ...
    # SMTP is optional only for development/test preview. No log-only success in working environments.
