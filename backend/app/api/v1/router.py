...
from app.api.v1 import (
    auth, activity, scratchpad, chat_inbox, chat_reaction_intents, work_orders, work_acceptances,
...
_remove_replaced_routes(chats.router, _TECHNICAL_SUPERVISION_CHAT_ROUTES | _CHAT_REACTION_ROUTES)
api_router.include_router(technical_supervision_chat.router)
api_router.include_router(chat_reaction_intents.router)
